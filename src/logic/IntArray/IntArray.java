...
public class IntArray implements Cloneable, Serializable {
    ...
    /**
     * @param conditionString Условие фильтрации. Строка, содержащая знак из набора (>, <, =, <>) и число из диапазона от -2^31 до 2^31-1
    ...
    /**
     * @param numbersString Условие фильтрации. Строка, содержащая знак из набора (>, <, =, <>) и число из диапазона от -2^31 до 2^31-1
     */
    ...
    /**
     * @param conditionString Условие фильтрации. Строка, содержащая знак из набора (>, <, =, <>) и число из диапазона от -2^31 до 2^31-1
     * @return Есть ли в массиве числа, удовлетворяющие условию
     */
